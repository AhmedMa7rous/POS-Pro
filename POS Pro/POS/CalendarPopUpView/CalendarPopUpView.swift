...
//            monthHeaderView.roundCorners([.topLeft, .topRight], radius: 4)
    ...
    override init(frame: CGRect ) {
      ...
      init(frame: CGRect,_startDate:Date) {
        super.init(frame: frame)
    ...
    private func commonSetup() {
        ...
        let calendar = VACalendar( selectedDate: startDate, calendar: defaultCalendar)
        
//        let day = VADay(date: startDate, state: .selected, calendar:  calendar.calendar)
