...
static int const RMD_ATTR_VALUE_MANUFACTURE_DATE                = 30018;
static int const RMD_ATTR_VALUE_SERIAL_NUMBER                   = 30030;
static int const RMD_ATTR_VALUE_MODEL_NUMBER                    = 30017;
static int const RMD_ATTR_VALUE_FIRMWARE_VERSION                = 30019;
static int const RMD_ATTR_VALUE_CHARGE_CAPACITY                 = 30029;
static int const RMD_ATTR_VALUE_BATTERY_HEALTH                  = 30013;
static int const RMD_ATTR_VALUE_CHARGE_CYCLES                   = 30021;
static int const RMD_ATTR_VALUE_FULL_CHARGE_CAPASITY            = 30020;
static int const RMD_ATTR_VALUE_CHARGE_PERCENTAGE               = 30012;
static int const RMD_ATTR_VALUE_BATTERY_CURRENT                 = 30011;
static int const RMD_ATTR_VALUE_CHARGE_STATUS                   = 30026;
static int const RMD_ATTR_VALUE_TIME_TO_FULL_CHARGE_COUNT       = 30023;
static int const RMD_ATTR_VALUE_BATTERY_VOLTAGE                 = 30010;
static int const RMD_ATTR_VALUE_BATTERY_CHARGE_LEVEL            = 30027;
static int const RMD_ATTR_VALUE_CURRENT_TEMPERATURE             = 30016;
static int const RMD_ATTR_VALUE_HIGHEST_TEMPERATURE             = 30024;
static int const RMD_ATTR_VALUE_LOWEST_TEMPERATURE              = 30025;
