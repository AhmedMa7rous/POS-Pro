...
import Foundation
class NotifierDevice:AddDevicesFactorProtocol{
    ...
    private func initalizeFieldList(){
        ...
        let ipString = "Notifier IP".arabic("IP  الاشعار")
    ...
    private func getSocketDeviceToSave() -> socket_device_class{
        ...
        new_device.type = DEVICES_TYPES_ENUM.NOTIFIER
        setValues(for:new_device )
        return new_device
    }
