...
@protocol GeideaTCPTransactionDelegate;
@protocol GeideaTCPRefundDelegate;
@protocol GeideaTCPReconcilaitionDelegate;
@protocol GeideaTCPReversalDelegate;
@class NSString;

SWIFT_CLASS("_TtC16GeideaParsingLib20GeideaParsingManager")
@interface GeideaParsingManager : NSObject
@property (nonatomic, strong) id <GeideaTCPDelegate> _Null_unspecified tcpDelegate;
@property (nonatomic, strong) id <GeideaTCPTransactionDelegate> _Null_unspecified transactionDelegate;
@property (nonatomic, strong) id <GeideaTCPRefundDelegate> _Null_unspecified refundDelegate;
@property (nonatomic, strong) id <GeideaTCPReconcilaitionDelegate> _Null_unspecified reconcilitionDelegate;
@property (nonatomic, strong) id <GeideaTCPReversalDelegate> _Null_unspecified reversalDelegate;
...
- (void)Reconciliation;
- (void)Reversal;
- (void)Refund:(NSString * _Nonnull)amount fordate:(NSString * _Nonnull)date forrrn:(NSString * _Nonnull)rrn;
- (void)Refund:(NSString * _Nonnull)amount fordate:(NSString * _Nonnull)date forrrn:(NSString * _Nonnull)rrn cardno:(NSString * _Nonnull)cardno;
@end


SWIFT_PROTOCOL("_TtP16GeideaParsingLib17GeideaTCPDelegate_")
@protocol GeideaTCPDelegate
- (void)checkCommStatus:(BOOL)status;
...
SWIFT_PROTOCOL("_TtP16GeideaParsingLib31GeideaTCPReconcilaitionDelegate_")
@protocol GeideaTCPReconcilaitionDelegate
...
SWIFT_PROTOCOL("_TtP16GeideaParsingLib23GeideaTCPRefundDelegate_")
@protocol GeideaTCPRefundDelegate
- (void)refundResponseHTML:(NSString * _Nonnull)htmlString;
- (void)refundResponseJSON:(Refund * _Nonnull)jsonResponse;
@end

@class Reversal;

SWIFT_PROTOCOL("_TtP16GeideaParsingLib25GeideaTCPReversalDelegate_")
@protocol GeideaTCPReversalDelegate
- (void)reversalResponseHTML:(NSString * _Nonnull)htmlString;
- (void)reversalResponseJSON:(Reversal * _Nonnull)jsonResponse;
@end

@class Transaction;

SWIFT_PROTOCOL("_TtP16GeideaParsingLib28GeideaTCPTransactionDelegate_")
@protocol GeideaTCPTransactionDelegate
...
SWIFT_CLASS("_TtC16GeideaParsingLib6Refund")
...
@property (nonatomic, copy) NSString * _Nonnull RefundAmountEn;
@property (nonatomic, copy) NSString * _Nonnull RefundAmountAr;
...
@property (nonatomic, copy) NSString * _Nonnull amountCreditMsgEn;
@property (nonatomic, copy) NSString * _Nonnull amountCreditMsgAr;
...
@property (nonatomic, copy) NSString * _Nonnull refundLabelEn;
@property (nonatomic, copy) NSString * _Nonnull refundLabelAr;
@property (nonatomic, copy) NSString * _Nonnull refundAmountLabelEn;
@property (nonatomic, copy) NSString * _Nonnull refundAmountLabelAr;
@property (nonatomic, copy) NSString * _Nonnull retailerSignLabelEn;
@property (nonatomic, copy) NSString * _Nonnull retailerSignLabelAr;
@property (nonatomic, copy) NSString * _Nonnull creditCustomerAccountLabelEn;
@property (nonatomic, copy) NSString * _Nonnull creditCustomerAccountLabelAr;
...
enum ReversalStatus : NSInteger;

SWIFT_CLASS("_TtC16GeideaParsingLib8Reversal")
@interface Reversal : NSObject
@property (nonatomic, copy) NSString * _Nonnull transactionDate;
@property (nonatomic, copy) NSString * _Nonnull transactionTime;
@property (nonatomic, copy) NSString * _Nonnull bankID;
@property (nonatomic, copy) NSString * _Nonnull merchantID;
...
@property (nonatomic) enum ReversalStatus transactionStatus;
@property (nonatomic, copy) NSString * _Nonnull transactionStatusEn;
@property (nonatomic, copy) NSString * _Nonnull transactionStatusAr;
@property (nonatomic, copy) NSString * _Nonnull pinVerifiedStatusEn;
@property (nonatomic, copy) NSString * _Nonnull pinVerifiedStatusAr;
...
@property (nonatomic, copy) NSString * _Nonnull cVMResult;
@property (nonatomic, copy) NSString * _Nonnull applicationCryt;
@property (nonatomic, copy) NSString * _Nonnull copyTitleAr;
@property (nonatomic, copy) NSString * _Nonnull copyTitleEn;
...
typedef SWIFT_ENUM(NSInteger, ReversalStatus, open) {
  ReversalStatusAccepted = 0,
  ReversalStatusDeclined = 1,
};
...
typedef SWIFT_ENUM(NSInteger, TransactionStatus, open) {
  ...
  TransactionStatusCANCELLATION = 2,
  TransactionStatusOFFLINE_APPROVED = 3,
};
